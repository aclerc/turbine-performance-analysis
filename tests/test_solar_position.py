...
from lidar_analysis.solar_position import SolarPositionCalculator
...
def test_non_utc_timestamp_raises_error(timestamp: dt.datetime, denver_calculator: SolarPositionCalculator) -> None:
    with pytest.raises(ValueError, match=re.escape("Timestamp must be timezone-aware and in UTC.")):
